...
from ...models import Game, Team, Season, ScrapingTask, TaskStatus, ScrapingLog, LineupPlayer
    ...
    **Response:**
    ...
    try:
        ...
        try:
            ...
            season_uuid = None
            if season_id:
                from ...models.competition import Season
...
def get_events_by_game(
    ...
    **Response:**
    ...
    from ...models.events_hybrid_schema import Events
