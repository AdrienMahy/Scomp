"""Add v_player_distance_by_speed_zone view

Revision ID: 20260917_085500
Revises: 20260916_143700
...
revision = '20260917_085500'
down_revision = '20260916_143700'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    op.execute("DROP VIEW IF EXISTS v_player_distance_by_speed_zone CASCADE;")
